...
The current browser experience implements the complete demo flow through a
deterministic local policy adapter. `contract/src/veilrisk.compact` contains the
matching Compact circuit. Wiring the generated bindings and Lace wallet is the
